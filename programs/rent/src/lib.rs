...
declare_id!("S6xBYpYTUn8LaAbG32dqMhWTyG647TLHBWnE1NLreNz");
...
pub mod rent {
    ...
    pub fn create_system_account(
        ...
        // todo Error: Deploying program failed: RPC response error -32002: Transaction simulation
        // failed: Error processing Instruction 0: account data too small for instruction [3 log messages]
        // msg!(
        //     "  System public key will be: {}",
